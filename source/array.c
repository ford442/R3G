...
document.getElementById('rcanvas').style.top=Math.floor((hhh*.555)+(Math.random(125)));
document.getElementById('rcanvas').style.left=Math.floor((www*.777)-(Math.random(255)));
